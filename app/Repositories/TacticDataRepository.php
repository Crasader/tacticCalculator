...
////                 }
    ...
    {
       // return [200, 440.04, 968.05, 2129.93, 4683.84, 10309.28, 22727.27]; // 64%
        //return [200, 440, 769, 1904.93, 4210.84, 9302.28, 20000]; // 64%

        // 20k -> 30k
        //$hanyados = [110, 49.99, 22.726, 10.32, 4.69, 2.13, 0.96]; //(+10%) 63%
        //$hanyados = [105, 47.72, 21.69, 9.86, 4.48, 2.04, 0.92]; //(+5%) 66%
        //$hanyados = [100, 45.45, 20.66, 9.39, 4.27, 1.94, 0.88]; //(best) 68%
        //$hanyados = [90, 40.91, 18.59, 8.45, 3.84, 1.75, 0.79]; //(-10%) 49%
        ...
        //bets =
        //return [50, 110, 242, 472, 911, 1717, 3216, 5991, 13000];
